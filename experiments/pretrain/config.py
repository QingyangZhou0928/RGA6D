...
_C.output_dir = osp.join(_C.root_dir, "output", "objaverse_gso")
...
# data
_C.data = edict()
_C.data.dataset_root = f'./datasets/RGA6D'
_C.data.ref_num_points = 900  
_C.data.src_num_points = 1700
_C.data.twice_sample = True
_C.data.check_overlap = True
_C.data.min_overlap = 0.2
...
_C.optim.max_iteration = 4000000000000000 
_C.optim.snapshot_steps = 100000
