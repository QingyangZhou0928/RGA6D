...
_C.output_dir = osp.join(_C.root_dir, "output", "o&g_partial_frozen_backbone_lm-12_2train-4_6val-8_11test")
...
# data
_C.data = edict()
_C.data.dataset_root = osp.join(f'./datasets/lm', "lm-12_2train-4_6val-8_11test") 
_C.data.ref_num_points = 900 
_C.data.src_num_points = 1800
