...
class SinusoidalPositionalEmbedding(nn.Module):
    ...
    def forward(self, emb_indices):
        ...
        omegas = emb_indices.view(-1, 1, 1) * self.div_term.view(1, -1, 1)  # (B*N*N,1,1)*(1,d_model/2,1)->(B*N*N,d_model/2,1)
        ...
        embeddings = embeddings.view(*input_shape, self.d_model)  # (*, d_model)  sin0, cos0, sin1, cos1, sin2, cos2 ...
