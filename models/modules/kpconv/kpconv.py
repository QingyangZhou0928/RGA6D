...
from models.modules.kpconv.kernel_points import load_kernels
...
class KPConv(nn.Module):
    ...
    def forward(self, s_feats, q_points, s_points, neighbor_indices):
        ...
        neighbors = neighbors - q_points.unsqueeze(1)  # (M, H, 3) relative distace
        ...
        kernel_outputs = torch.matmul(weighted_feats, self.weights)  # (K, M, C) x (K, C, C_out) -> (K, M, C_out) weights代表特征映射关系
