...
from models.engine.base_trainer import BaseTrainer
...
class IterBasedTrainer(BaseTrainer):
    ...
    def run(self):
        ...
        while self.iteration < self.max_iteration:
            ...
            if output_dict['src_points_c'].shape[0] > current_max_src_c_num:
                current_max_src_c_num = output_dict['src_points_c'].shape[0]
            ...
            total_norm = self.print_gradients()
            ...
            if self.iteration % self.log_steps == 0:
                ...
                summary_dict['gradient_norm'] = total_norm
                summary_dict['max_src_c_num'] = current_max_src_c_num
                message = get_log_string(
